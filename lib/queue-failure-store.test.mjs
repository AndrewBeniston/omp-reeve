...
test("sanitizeErrorSummary keeps the redacted field name", () => {
  assert.equal(sanitizeErrorSummary("token: abc123"), "token=[redacted]");
  assert.doesNotMatch(sanitizeErrorSummary("password: abc123"), /\$1/);
});
