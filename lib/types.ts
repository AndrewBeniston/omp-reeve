...
export interface SessionInfo {
  ...
  cwd: string;
  name?: string;
  /** OMP-Web list preference. It does not modify the session file. */
  pinned?: boolean;
  created: string;
  modified: string;
  messageCount: number;
  ...
  /** Current Git branch for this session directory */
  gitBranch?: string;
  /** Origin repository label, such as owner/repo */
  repositoryLabel?: string;
  /** True when the session directory is a linked Git worktree */
  isWorktree?: boolean;
