...
16. Branch protection (2026-09-11). Point 2 states that `main` is protected. It is not yet. Issue #3 tracks the setting. Until it is on, the rule holds by habit and not by the platform.
