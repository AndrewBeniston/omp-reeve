...
Reeve's interface uses a small internal i18n layer. It is intentionally kept
...
/** Reeve Japanese language package. */
...
Reeve is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using Reeve, not be treated as a measure
