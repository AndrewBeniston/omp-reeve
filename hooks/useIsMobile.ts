...
// Narrow desktop windows keep the desktop shell. Touch devices use the mobile shell.
...
/**
 * Returns true when a touch viewport is at or below the mobile breakpoint.
